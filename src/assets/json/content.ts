const content = [
    {
        ...
        children: [
            {
                id: "",
                name: "To study sth at school, university etc",
                header: "group",
                children: [
                    {
                        id: "",
                        ...
                        examples: ["It’s difficult to study when the weather’s so hot."],
                        children: [
                            {
                                id: "",
                                name: "study English/Biology/Music etc",
                                header: "collocation",
                                body: "branch",
                                frequency: "A1",
                                examples: [
                            ...
                            {
                                id: "",
                                name: "study to be a doctor/lawyer/accountant etc",
                                header: "collocation",
                                body: "branch",
                                frequency: "A1",
                                examples: ["What classes are you taking next semester?"],
                            },
                        ],
                    },
                    {
                    ...
                    },
                    {
                        ...
                        definition:
                            "[T] to study a subject - use this to talk about subjects that you choose to study at school, college, university etc:",
                        examples: ["Jenny has a place to study law at Exeter this year."],
                    },
                ],
            },
            {
                id: "",
                name: "To learn how to do sth, or to learn about sth",
                header: "group",
                children: [
                    {
                        id: "",
                        ...
                        frequency: "A1",
                        definition:
                            "[I or T] to learn how to do sth, or to learn about a subject, especially by being taught or trained: học",
                        examples: ["How long have you been learning German?"],
                        children: [
                            {
                                id: "",
                                name: "learn to do sth",
                                header: "collocation",
                                body: "branch",
                                frequency: "A1",
                                examples: [
                            ...
                            {
                                id: "",
                                definition: "learn a method or skill",
                                name: "learn how to do sth",
                                header: "collocation",
                                body: "branch",
                                frequency: "A1",
                                examples: [
                    ...
                    },
                    {
                        ...
                        examples: ["Chris trained at an airbase in Honduras."],
                        children: [
                            {
                                id: "",
                                name: "learn to do sth",
                    ...
                    },
                    {
                        ...
                        frequency: "B2",
                        definition:
                            "[T phrasal verb] informal to learn sth easily, without making much effort or having lessons",
                        children: [
                            {
                                id: "",
                                name: "learn to do sth",
